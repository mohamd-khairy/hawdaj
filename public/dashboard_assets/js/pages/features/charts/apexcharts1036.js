"use strict";
const primary = "#6993FF", success = "#29abe2", info = "#8950FC", warning = "#FFA800", danger = "#F64E60";

function generateBubbleData(e, a, t) {
    for (var n = 0, r = []; n < a;) {
        var o = Math.floor(750 * Math.random()) + 1, i = Math.floor(Math.random() * (t.max - t.min + 1)) + t.min,
            s = Math.floor(61 * Math.random()) + 15;
        r.push([o, i, s]), 864e5, n++
    }
    return r
}
...
function generateData(e, a) {
    for (var t = 0, n = []; t < e;) {
        var r = "w" + (t + 1).toString(), o = Math.floor(Math.random() * (a.max - a.min + 1)) + a.min;
        n.push({x: r, y: o}), t++
    }
    return n
}
...
var KTApexChartsDemo = {
    init: function () {
        ...
        e = {
            ...
            colors: [primary]
        }, new ApexCharts(document.querySelector("#chart_1"), e).render(), function () {
            var e = {
            ...
            new ApexCharts(document.querySelector("#chart_2"), e).render()
        }(), function () {
            var e = {
            ...
            new ApexCharts(document.querySelector("#chart_3"), e).render()
        }(), function () {
            var e = {
            ...
            new ApexCharts(document.querySelector("#chart_4"), e).render()
        }(), function () {
            var e = {
                series: [{
                    name: "Income",
                ...
                yaxis: [{
                    axisTicks: {show: !0},
                    axisBorder: {show: !0, color: primary},
                    labels: {style: {colors: primary}},
                    title: {text: "Income (thousand crores)", style: {color: primary}},
                    tooltip: {enabled: !0}
                }, {
                    seriesName: "Income",
                    opposite: !0,
                    axisTicks: {show: !0},
                    axisBorder: {show: !0, color: success},
                    labels: {style: {colors: success}},
                    title: {text: "Operating Cashflow (thousand crores)", style: {color: success}}
                }, {
                    seriesName: "Revenue",
                    opposite: !0,
                    axisTicks: {show: !0},
                    axisBorder: {show: !0, color: warning},
                    labels: {style: {colors: warning}},
                    title: {text: "Revenue (thousand crores)", style: {color: warning}}
                }],
                tooltip: {fixed: {enabled: !0, position: "topLeft", offsetY: 30, offsetX: 60}},
                legend: {horizontalAlign: "left", offsetX: 40}
            };
            new ApexCharts(document.querySelector("#chart_5"), e).render()
        }(), function () {
            var e = {
                series: [{
                    data: [{
                ...
                dataLabels: {
                    enabled: !0, formatter: function (e, a) {
                        var t = a.w.globals.labels[a.dataPointIndex], n = moment(e[0]),
                            r = moment(e[1]).diff(n, "days");
                        return t + ": " + r + (r > 1 ? " days" : " day")
            ...
            new ApexCharts(document.querySelector("#chart_6"), e).render()
        }(), function () {
            var e = {
                series: [{
            ...
            new ApexCharts(document.querySelector("#chart_7"), e).render()
        }(), function () {
            var e = {
                series: [{
                    name: "Bubble1",
            ...
            new ApexCharts(document.querySelector("#chart_8"), e).render()
        }(), function () {
            var e = {
                series: [{
                    name: "SAMPLE A",
            ...
            new ApexCharts(document.querySelector("#chart_9"), e).render()
        }(), function () {
            var e = {
                ...
                plotOptions: {
                    heatmap: {
                        shadeIntensity: .5,
                        colorScale: {
                            ranges: [{from: -30, to: 5, name: "low", color: success}, {
                                from: 6,
                                to: 20,
                                name: "medium",
                                color: primary
                            }, {from: 21, to: 45, name: "high", color: warning}, {
                                from: 46,
                                to: 55,
                                name: "extreme",
                                color: danger
            ...
            new ApexCharts(document.querySelector("#chart_10"), e).render()
        }(), function () {
            var e = {
            ...
            new ApexCharts(document.querySelector("#chart_11"), e).render()
        }(), function () {
            var e = {
            ...
            new ApexCharts(document.querySelector("#chart_13"), e).render()
        }(), function () {
            var e = {
            ...
            new ApexCharts(document.querySelector("#chart_14"), e).render()
        }()
    }
};

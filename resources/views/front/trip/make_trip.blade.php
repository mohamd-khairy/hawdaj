<style>
    ...
    .popup_that_shows_on_startup .tab>.left-side>*:not(h6):not(.trip_categories):not(a):not(.navigation_buttons),
        ...
        <form action="{{ route('front.action_selected_places') }}" method="POST" id="trip_form">
            ...
            <div class="tabs row">
                ...
                <div dir="{{ app()->getLocale() === 'en' ? 'ltr' : 'rtl' }}" class="tab hide col-12">
                    ...
                    <div class="right-side">
                        <img src="{{ asset('front_assets/imgs/popup_images/popup_1.png') }}"

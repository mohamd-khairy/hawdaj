            ...
            <section class="filter-section">
                <div class="container-fluid">
                    <form id="filterForm" class="filter-section__filters-form">
                        <input type="text" class="form-control" value="{{ request('search') }}" placeholder="اسم المكان"
                            name="search">
                        ...
                        <select class="form-control select2-input" name="price_id" id="price_id">
                            <option selected value="0">السعر</option>
                            @foreach ($prices as $price)
                                <option value="{{ $price->id }}"
                                    {{ request('price_id') == $price->id ? 'selected' : '' }}>{{ $price->name }}
                                </option>
                            @endforeach
                        </select>
                        <input type="number" value="{{ request('temperature') }}" class="form-control"
                            placeholder="درجه الحرارة" name="temperature">
                            ...
                            <div class="filter-grid-section__container filter-grid-section--height">
                                ...
                                <div class="row mx-0">
                                    @foreach ($places as $place)
                                        <div class="col-12 col-sm-6 col-md-4 col-lg-12 col-xl-6 mb-4 d-flex">
                                ...
                                {!! $places->withQueryString()->links('vendor.pagination.custom') !!}
                            </div>
                        </div>
                    </div>
                </div>
...
@section('scripts')
    ...
    function initMap() {
        ...
        var data = '<?= json_encode($places_data_for_map) ?>';

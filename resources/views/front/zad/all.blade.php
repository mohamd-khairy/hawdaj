    ...
    <div class="overflow-hidden pt-3">
        ...
        <section class="filter-section">
            <div class="container-fluid">
                <form id="filterForm" class="filter-section__filters-form">
                    <input type="text" class="form-control" value="{{ request('search') }}" placeholder="اسم المتجر" name="search">
                    <select class="form-control select2-input" name="category_id" id="category_id" onchange="get_sub_categories()">
                        <option selected value="0">التصنيف</option>
                    ...
                    <select class="form-control select2-input" name="sub_category_id" id="sub_category_id">
                        <option selected value="0"> التصنيف الفرعي</option>
                    </select>
                    <select class="form-control select2-input" name="address_type" id="address_type" >
                        <option selected value="0">نوع الموقع</option>
                        <option value="link" {{ request('address_type') == 'link' ? 'selected' : '' }}>link</option>
                        <option value="map" {{ request('address_type') == 'map' ? 'selected' : '' }}>map</option>
                    </select>
        ...
        <section class="filter-grid-section filter-grid-section--height">
            <div class="container">
                <div class="row">
                        ...
                        <div class="filter-grid-section__map-container filter-grid-section--height">
                            ...
                            <div class="map-toggler">
                                <button id="googleMapType" class="btn" onclick="initMap()">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-map-2" width="1.3rem" height="1.3rem" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                ...
                                <button id="customMapType" class="btn" onclick="KSAMAP()">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-map" width="1.3rem" height="1.3rem" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                            ...
                            <button class="btn show-fullscreen-map-navigator" id="showFullscreenMapPage">
                                <svg xmlns="http://www.w3.org/2000/svg" width="1.3rem" height="1.3rem" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                    ...
                    <div class=" @if(request('address_type') == 'map') col-lg-4 col-xl-6 @else col-lg-12 col-xl-12 @endif ">
                            ...
                            <div class="filter-grid-section__container filter-grid-section--height">
                                ...
                                <div class="row mx-0">
                                    ...
                                    <div class="@if(request('address_type') == 'map') col-12 col-sm-6 col-md-4 col-lg-12 col-xl-6  @else col-3 @endif  mb-4 d-flex">
                                        <a href="{{ url($store->type.'-details/' . $store->id) }}" class="palce-card card h-100">
                                            <!-- tooltip -->
                                            <div class="palce-card__tooltip">
                                                <img src="{{ asset($store->image) }}" class="palce-card__tooltip--img" alt="store">
                                                <div class="palce-card__tooltip--text">
                                                    <h5 class="map-card__title"> {{ $store->title }}</h5>
                                                    <p class="map-card__text">{{ $store->city ? $store->city->name : '' }},
                                                    ...
                                                    <div class="d-flex align-items-center mb-3">
                                                        <div class="rate d-flex align-items-center"><span class="mx-1"><svg width="14" height="13" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                ...
                                                                </svg></span><span class="mx-1">{{ $store->rate }}</span></div>
                                            ...
                                            <!-- card img -->
                                            <img src="{{ asset($store->image) }}" class="card-img-top" alt="store">
...
<script>
    ...
    const KSAStates = Highcharts.maps["ksa"].features
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.length > 0) {
                        ...
                        let result = '<option selected value="0"> التصنيف الفرعي</option>';
                        $("#sub_category_id").html('')
                        $("#sub_category_id").append(result)
                    }
                },

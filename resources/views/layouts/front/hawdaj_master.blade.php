            ...
            <div class="row">
                <div class="col-lg-4 logo">
                    <div class="d-flex align-items-center mb-4">
                        ...
                        <span class="tajawal-bold heading">{{ $settings->where('group', 'main_services')->where('key', 'SECTION_TITLE')->first()->value ?? 'test' }}</span>
                    </div>
                    <p class="mb-4">
                    ...
                    <div class="mb-4 mb-lg-0">
                        ...
                        <ul class="social-media d-flex align-items-center">
                            <li>
                                <a href="{{$settings->where('group', 'app')->where('key', 'INSTGRAM')->first()->value ?? '#'}}" target="_blank">
                                    <span>Instagram</span>
                                    <span class="icon">
                            ...
                            <li>
                                <a href="{{$settings->where('group', 'app')->where('key', 'TWITTER')->first()->value ?? '#'}}" target="_blank">
                                    <span>Twitter</span>
                                    <span class="icon">
                            ...
                            <li>
                                <a href="{{$settings->where('group', 'app')->where('key', 'FACEBOOK')->first()->value ?? '#'}}" target="_blank">
                                    <span>Facebook</span>
                                    <span class="icon">

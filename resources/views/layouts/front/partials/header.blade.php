    ...
    <div class="header__content container px-0 px-sm-3">
        ...
        <div class="additional_bar_login_and_welcome">
            <div class="home_login_buttons_area">
                <button class="home_login_button" onclick="openHomeRegisterAndLoginPopup()">{{__('dashboard.login')}}</button>
            </div>
        ...
        <div class="home_login_and_register_form_container hide" dir="{{app()->getLocale() == 'en' ? 'ltr' : 'rtl'}}">

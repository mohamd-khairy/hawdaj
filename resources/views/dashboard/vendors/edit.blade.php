...
@section('page_header')
    ...
    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
        ...
        <li class="breadcrumb-item text-muted">
            <a href="{{url('dashboard/vendors')}}" class="text-muted">@lang('dashboard.vendors')</a>
        </li>
        <li class="breadcrumb-item text-muted">
            <a href="javascript:;" class="text-muted">@lang('dashboard.edit_vendor')</a>
        </li>
    </ul>
@endsection
                ...
                <div class="col-md-12">
                    <div class="card card-custom gutter-b ">
                        <div class="card-header">
                            <h3 class="card-title">@lang('dashboard.edit_vendor')</h3>
                        ...
                        <form novalidate="novalidate" class="kt-form kt-form--label-right" method="post"
                              action="{{ route('dashboard.vendors.update',$vendor->id) }}"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group validated">
                                            <label>@lang('dashboard.first_name') </label> <span
                                                class="text-danger"> *</span>
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                            <span class="input-group-text">
                                                <i class="la la-exclamation-triangle flaticon-vendor"></i>
                                            </span>
                                                </div>
                                                <input type="text" name="first_name" value="{{$vendor->first_name}}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group validated">
                                            <label>@lang('dashboard.last_name') </label> <span
                                                class="text-danger"> *</span>
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                            <span class="input-group-text">
                                                ...
                                                <input type="text" name="last_name" value="{{$vendor->last_name}}"
                                            ...
                                            <select id="role" class="form-control nice-select" name="role">
                                                @foreach($roles as $role)
                                                    <option value="{{$role->id}}" data-name="{{strtolower($role->name)}}"
                                                        {{ $role->id == $vendor->roles()->first()->id ? 'selected' : '' }}>
                                                        {{$role->label}}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group validated">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input name="phone" type="number" value="{{$vendor->phone}}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row validated">
                                            <div class="col-md-10">
                                                <label>{{__('dashboard.vendor_photo')}}</label>
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text" id="basic-addon1">
                                                    ...
                                                    <input type="file" id="file" name="photo"
                                                           ...
                                                           placeholder="{{__('dashboard.enter')}} {{__('dashboard.vendor_photo')}}"
                                                           aria-describedby="basic-addon1">
                                                    <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-2 image">
                                                <div class="image_prev_form thumb-output">
                                                    <img src="{{resolvePhoto($vendor->photo)}}"/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>

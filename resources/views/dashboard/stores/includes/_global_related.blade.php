<form id="form" novalidate="novalidate" class="kt-form kt-form--label-right" method="POST" action="{{ route('dashboard.stores.related', $data->id) }}" enctype="multipart/form-data">
    @csrf
    @method('POST')

<div class="row justify-content-md-center">
    <div class="col-12 search-permission-cont">
        ...
        <form action="{{route('dashboard.carguard.car_search')}}" method="GET">
            <div class="row ">
                <div class="mb-2 col-12 col-md-5">
                    <select class="nice-select form-control" name="searchType">
                        <option value="1">{{ __('dashboard.car_request_id') }}</option>
                        <option value="2">{{ __('dashboard.driver_id') }}</option>
                    </select>
                </div>
                <div class="mb-2 col-12 col-md-5">
    ...
    <div class="col-12 qr-scan-cont ">
        <div class="row justify-content-md-center ">
            ...
            <div class="col-12 col-md-6 col-lg-4 text-center mx-auto">
                ...
                <div class="mt-4">
                    <a type="button" onclick="ScanCarCode()"  class="btn btn-outline-success btn-custom-color btn-block">{{ __('dashboard.scan') }}</a>
                </div>
            </div>
            <form id="scanMatForm" action="{{route('dashboard.carguard.car_search')}}" method="GET">
...
{{--                                    <video id="material_preview" width="100%" style="display:none"></video>--}}
{{--                                    <div class="mt-4">--}}
{{--                                        <a type="button" onclick="ScanCarCode()" class="btn btn-outline-secondary btn-block">{{ __('dashboard.scan') }}</a>--}}
{{--                                    </div>--}}
{{--                                </div>--}}
{{--                                <form id="scanMatForm" action="{{route('dashboard.carguard.car_search')}}" method="GET">--}}
{{--                                    <input type="hidden" name="searchType" value="1" class="forn-control">--}}

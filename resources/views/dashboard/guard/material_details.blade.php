...
@section('content')
            ...
            <div class="row justify-content-md-center">
                <div class="col-12 col-md-3">
                    <ul class="nav nav-pills scroll-sm-nav-pills flex-md-column rounded bg-white" id="myTab1"
                        role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="material-tab-1" data-toggle="tab" href="#material-1">
                                                <span class="nav-icon">
                                                    <!-- <i class="flaticon2-user"></i> -->
                                                    <i class="flaticon2-box-1  "></i>
                                                </span>
                                <span class="nav-text">{{ __('dashboard.material') }}</span>
                            </a>
                        </li>
                        <li class="nav-item">
                ...
                <div class="col-12 col-md-9">
                    <div class="card-body rounded bg-white">
                        <div class="tab-content  " id="myTabContent1">
                            <div class="tab-pane fade show active" id="material-1" role="tabpanel"
                                 aria-labelledby="material-tab-1">
                                <!-- first tab form -->
                            @include('dashboard.guard.tabs.material_data')
                            <!-- end first tab form -->
                            </div>
                            <!--  tab -->
                            <div class="tab-pane fade" id="contact-1" role="tabpanel" aria-labelledby="contact-tab-1">
                                @include('dashboard.guard.tabs.material_contact')
                            </div>
                            <!-- end  tab -->

                            <!-- take action -->
                            <div class="mt-4" >
                                <a type="button" id="guardtakeAction"
                                   class="btn btn-success">{{ __('dashboard.take_action') }}</a>
                            </div>
                        </div>
                    </div>
    ...
    {{--                                        <div class="tab-pane fade show active" id="material-1" role="tabpanel" aria-labelledby="material-tab-1">--}}
    {{--                                            <!-- first tab form -->--}}
    {{--                                            @include('dashboard.guard.tabs.material_data')--}}
    {{--                                            <!-- end first tab form -->--}}
    {{--                                        </div>--}}
    ...
    {{--                                    <a type="button" id="guardtakeAction" class="btn btn-outline-success">{{ __('dashboard.take_action') }}</a>--}}
    {{--                                </div>--}}
    {{--                                <!-- end take action -->--}}
    {{--                            </div>--}}
    {{--                        </div>--}}
    ...
    <!-- begin::page -->
    <!-- Modal-->
    @include('dashboard.guard.matrialAction')
    <!-- end Modal -->
@endsection

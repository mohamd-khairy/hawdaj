                    ...
                    <ul class="nav nav-pills scroll-sm-nav-pills flex-md-column rounded bg-white" id="myTab1"
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" id="home-tab-1" data-toggle="tab" href="#home-1">
                                ...
                                <span class="nav-text">{{ __('dashboard.contractor') }}</span>
                            </a>
                        </li>
                        {{--                                    <li class="nav-item">--}}
                    ...
                    <div class="card-body rounded bg-white">
                        ...
                        <div class="tab-content mt-5" id="myTabContent1">
                            <div class="tab-pane fade show active" id="home-1" role="tabpanel" aria-labelledby="home-tab-1">
                                <!-- first tab form -->
                            @include('dashboard.guard.tabs.contractor')
                            <!-- end first tab form -->
                            </div>
                            <!-- permission tab -->
                        ...
                        <!-- End tabs -->
                        <!-- take action -->
                        {{--                                @if($contractorData->status === "approve")--}}
                        <div class="mt-4" >
                            <a type="button" id="contractTakeAction" class="btn btn-success">{{ __('dashboard.take_action') }}</a>
                        </div>
                    {{--                            @endif--}}
                    <!-- end take action -->
                    </div>
...
{{--                                @if($contractorData->status === "approve")--}}
                                    <div class="text-center" style="margin-top: -30px">
                                        <a type="button" id="contractTakeAction" class="btn btn-outline-success">{{ __('dashboard.take_action') }}</a>
                                    </div>
{{--                            @endif--}}
                            <!-- end take action -->
                            </div>
    ...
    <!-- Modal-->
    @include('dashboard.guard.tabs.contractorAction')
    <!-- end Modal -->
@endsection

<div class="row justify-content-md-center">
    <div class="col-12 search-permission-cont">
        ...
        <form action="{{route('dashboard.materialguard.material_search')}}" method="GET">
            <div class="row ">
                <div class="mb-2 col-12 col-md-5">
                    <select class="nice-select form-control" name="searchType">
                        <option value="2">{{ __('dashboard.material_requests_id') }}</option>
                        <option value="3">{{ __('dashboard.materials_phone_number') }}</option>
                    </select>
                </div>
                <div class="mb-2 col-12 col-md-5">
    ...
    <div class="col-12 qr-scan-cont ">
        <div class="row justify-content-md-center">
            ...
            <div class="col-12 col-md-6 col-lg-4 text-center mx-auto">
                ...
                <img id="material_defualtScanImage" class="mb-2" src="/dashboard_assets/media/qr_code.png" alt="" width="50%">
                <video id="material_preview" width="100%" style="display:none"></video>
                <div class="mt-4">
                    <a type="button" onclick="ScanmaterialCode()" class="btn btn-outline-success btn-custom-color btn-block">{{ __('dashboard.scan') }}</a>
                </div>
            </div>
            <form id="scanMatForm" action="{{route('dashboard.materialguard.material_search')}}" method="GET">
                <input type="hidden" name="searchType" value="1" class="forn-control">
                <input type="hidden" name="value" id="Matvalue"  placeholder="scan qrcode" class="form-control">
            </form>
        </div>
    </div>
</div>
...
{{--                                    <video id="material_preview" width="100%" style="display:none"></video>--}}
{{--                                    <div class="mt-4">--}}
{{--                                        <a type="button" onclick="ScanmaterialCode()" class="btn btn-outline-secondary btn-block">{{ __('dashboard.scan') }}</a>--}}
{{--                                    </div>--}}
{{--                                </div>--}}
{{--                                <form id="scanMatForm" action="{{route('dashboard.materialguard.material_search')}}" method="GET">--}}
{{--                                    <input type="hidden" name="searchType" value="1" class="forn-control">--}}

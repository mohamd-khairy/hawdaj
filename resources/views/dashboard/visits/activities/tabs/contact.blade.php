            ...
            <div class="row">
                        ...
                        <div class="card-body">
                            <div class="row ">
                                ...
                                <div class="col-6 mb-3">
                                    <p>{{$visitorReq->visitor->fullname??"---"}}</p>
                                </div>
                                ...
                                <div class="col-3 mb-3">
                                    <p>{{$visitorReq->visitor->id_type??"---"}}</p>
                                </div>
                                <div class="col-3 mb-3">
                                    <b class="text-muted">{{__('dashboard.mobile')}}</b>
                                </div>
                                <div class="col-3 mb-3">
                                    <p>{{$visitorReq->visitor->mobile??"---"}}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-12">
                    <div class="card modal-card card-custom gutter-b mb-2 card-shadowless">
                        <div class="card-header">
                            <div class="card-title">
                                <h4 class=" card-label">{{__('dashboard.other_info')}}</h4>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6 mb-3">
                                            <p>{{$visitorReq->visitor->nationality??"---"}}</p>
                                        </div>
                                        <div class="col-6 mb-3">
                                            <b class="text-muted">{{__('dashboard.company')}}</b>
                                        </div>
                                        <div class="col-6 mb-3">
                                            <p>{{$visitorReq->visitor->company->name??"---"}}</p>
                                        </div>
                                        <div class="col-6 mb-3">
                                            <b class="text-muted">{{__('dashboard.gender')}}</b>
                                        </div>
                                        <div class="col-6 mb-3">
                                            <p>{{$visitorReq->visitor->gender??"---"}}</p>
                                        </div>
                                        <div class="col-6 mb-3">
                                            <b class="text-muted">{{__('dashboard.position')}}</b>
                                        </div>
                                        <div class="col-6 mb-3">
                                            <p>{{$visitorReq->visitor->position??"---"}}</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-6">
                                    ...
                                    <br>
                                    <div>
                                        <img src="{{resolvePhoto($visitorReq->visitor->id_copy,'none')}}" style="width: 25%; border: 1px solid #EEE"
                                             alt="">
                                    </div>
                                </div>
                            </div>

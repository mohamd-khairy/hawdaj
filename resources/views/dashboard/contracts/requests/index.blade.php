            ...
            <div class="card card-custom">
                <div class="card-header flex-wrap border-0 pt-2 pb-0">
                    <div class="card-title">
                        <h3 class="card-label">@lang('dashboard.contract_requests_table')</h3>
                    </div>
                    <div class="card-toolbar">
                        <a href="{{url('dashboard/contract-requests/create')}}"
                ...
                <div class="card-body">
                    ...
                    <table class="table" id="dataTable">
                        ...
                        <tbody>
                        @if(!empty($contractRequests->first()))
                            @foreach($contractRequests as $index => $request)

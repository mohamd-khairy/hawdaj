<div class="row">
    ...
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
        <div class="form-group fv-plugins-icon-container">
            ...
            <input type="text" class="form-control form-control-solid" name="first_name" placeholder="{{ __('dashboard.first_name') }}" value="{{ $visitorRequest->visitor['first_name'] }}">
    ...
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
        <div class="form-group fv-plugins-icon-container">
            ...
            <input type="text" class="form-control form-control-solid" name="last_name" placeholder="{{ __('dashboard.last_name') }}" value="{{ $visitorRequest->visitor['last_name'] }}">
            <div class="fv-plugins-message-container"></div>
        </div>
    </div>
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
        <div class="form-group fv-plugins-icon-container">
            ...
            <input type="text" class="form-control form-control-solid" name="id_type" placeholder="{{ __('dashboard.id_type') }}" value="{{ $visitorRequest->visitor['id_type'] }}">
            <div class="fv-plugins-message-container"></div>
        </div>
    </div>
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
        <div class="form-group fv-plugins-icon-container">
            ...
            <input type="text" class="form-control form-control-solid" name="id_number" placeholder="{{ __('dashboard.id_number') }}" value="{{ $visitorRequest->visitor['id_number'] }}">
            <div class="fv-plugins-message-container"></div>
        </div>
    </div>
    ...
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
        <div class="form-group fv-plugins-icon-container">
            ...
            <input type="text" class="form-control form-control-solid" name="mobile" placeholder="{{ __('dashboard.mobile') }}" value="{{ $visitorRequest->visitor['mobile'] }}">
            <div class="fv-plugins-message-container"></div>
        </div>
    </div>
    ...
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
        <div class="form-group fv-plugins-icon-container">
            ...
            <input type="email" class="form-control form-control-solid" name="email" placeholder="{{ __('dashboard.email') }}" value="{{ $visitorRequest->visitor['email'] }}">
            <div class="fv-plugins-message-container"></div>
        </div>
    </div>
    ...
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
        <div class="form-group fv-plugins-icon-container">
            ...
            <select class="nice-select form-control" value="{{ $visitorRequest->visitor['gender'] }}" name="gender">
    ...
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
        <div class="form-group fv-plugins-icon-container">
            ...
            <input type="text" class="form-control form-control-solid" name="company"
                   placeholder="{{ __('dashboard.company') }}" value="{{ optional($visitorRequest->visitor->company)['name'] }}">
            <div class="fv-plugins-message-container"></div>
        </div>
    </div>
    ...
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
        <div class="form-group fv-plugins-icon-container">
            ...
            <input type="text" class="form-control form-control-solid" name="position"
                   ...
                   value="{{ optional($visitorRequest->visitor->company)['position'] }}">
            <div class="fv-plugins-message-container"></div>
        </div>
    </div>
    ...
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
        <div class="form-group fv-plugins-icon-container">
            ...
            <input type="text" class="form-control form-control-solid" name="company_mobile"
                   placeholder="{{ __('dashboard.mobile') }}"  value="{{optional($visitorRequest->visitor->company)['mobile']}}">
            <div class="fv-plugins-message-container"></div>
        </div>
    </div>
    ...
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
        <div class="form-group fv-plugins-icon-container">
            ...
            <input type="text" class="form-control form-control-solid" name="company_email"
                   placeholder="{{ __('dashboard.email') }}" value="{{optional($visitorRequest->visitor->company)['email']}}">
            <div class="fv-plugins-message-container"></div>
        </div>
    </div>
    ...
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
        <div class="form-group fv-plugins-icon-container">
            ...
            <input type="text" class="form-control form-control-solid" name="vehicle_detail"
                   placeholder="{{ __('dashboard.vehicle_detail') }}" value="{{$visitorRequest->visitor['vehicle_detail']}}">
            <div class="fv-plugins-message-container"></div>
        </div>
    </div>
    ...
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
        ...
        <div class="form-group fv-plugins-icon-container">
            <input type="text" class="form-control form-control-solid" name="vehicle_material"
                   placeholder="{{ __('dashboard.vehicle_material') }}" value="{{$visitorRequest->visitor['vehicle_material']}}">
            <div class="fv-plugins-message-container"></div>
        </div>
    </div>
    ...
    <div class="col-md-6">
        ...
        <div class="image_prev_form thumb-output">
                    <img src="{{resolvePhoto($visitorRequest->visitor['personal_photo'])}}"/>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="form-group row validated">
            ...
            <div class="col-md-2 image">
        <div class="image_prev_form thumb-output">
            <img src="{{resolvePhoto($visitorRequest->visitor['id_copy'])}}"/>
                </div>
            </div>
        </div>
    </div>

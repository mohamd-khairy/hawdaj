<form id="form" novalidate="novalidate" class="kt-form kt-form--label-right" method="post" action="{{ route('dashboard.zad_elgadels.update', $data->id) }}" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group validated">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="city_id" value="{{$data->city_id ?? ''}}" class="form-control {{ $errors->has('city_id') ? 'is-invalid' : '' }}" placeholder="@lang('dashboard.enter') @lang('dashboard.city_id') " aria-describedby="basic-addon1">

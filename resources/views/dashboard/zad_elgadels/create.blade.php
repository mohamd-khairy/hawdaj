                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group validated">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="city_id" value="{{old("city_id")}}" class="form-control {{ $errors->has('city_id') ? 'is-invalid' : '' }}" placeholder="@lang('dashboard.enter') @lang('dashboard.city_id') " aria-describedby="basic-addon1">
                                            <div class="invalid-feedback">

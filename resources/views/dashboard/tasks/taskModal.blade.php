<div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-xl" role="document">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">{{ __('dashboard.visitor_details') }}</h5>
                    ...
                    <div class="container-fluid">
                        <div class="example-preview custom-nav modal-nav">
                            <ul class="nav nav-tabs custom-nav-tabs" id="myTab1" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="health-tab-1" data-toggle="tab" href="#health-1"
                            ...
                            <div class="tab-content mt-5" id="myTabContent1">
                                <div class="tab-pane fade show active" id="details" role="tabpanel"
                                    ...
                                    @include('dashboard.tasks.tabs.details')
                                </div>
                                <div class="tab-pane fade" id="contact-1" role="tabpanel"
                                     aria-labelledby="contact-tab-1">
                                    @include('dashboard.tasks.tabs.contact')
                                </div>
                                <div class="tab-pane fade" id="health-1" role="tabpanel"
                                     aria-labelledby="health-tab-1">
                                    @include('dashboard.tasks.tabs.health_check')
                                </div>
                                <div class="tab-pane fade" id="action-1" role="tabpanel"
                                     aria-labelledby="action-tab-1">
                                    @include('dashboard.tasks.tabs.action')
                                </div>
                            </div>
                        </div>
                    </div>

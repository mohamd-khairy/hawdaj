...
@section('page_header')
    ...
    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
        ...
        <li class="breadcrumb-item text-muted">
            <a href="{{url('dashboard/setting/features')}}" class="text-muted">@lang('dashboard.features')</a>
        </li>
        <li class="breadcrumb-item text-muted">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-custom gutter-b ">
                        ...
                        <form id="form" novalidate="novalidate" class="kt-form kt-form--label-right" method="post"  action="{{ route('dashboard.features.update' , $feature->id) }}" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group validated">
                                            <label>@lang('dashboard.feature_name')</label> <span class="text-danger"> *</span>
                                        ...
                                        <div class="form-group validated">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <textarea type="text" class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}"
                                                          ...
                                                          placeholder="@lang('dashboard.enter') @lang('dashboard.description')">{{$feature->notes ?? ''}}</textarea>
                                                <div class="invalid-feedback">

...
@section('page_header')
    ...
    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
        ...
        <li class="breadcrumb-item text-muted">
            <a href="{{url('dashboard/setting/regions')}}" class="text-muted">@lang('dashboard.regions')</a>
        </li>
        <li class="breadcrumb-item text-muted">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-custom gutter-b ">
                        ...
                        <form id="form" novalidate="novalidate" class="kt-form kt-form--label-right" method="post"  action="{{ route('dashboard.regions.update' , $region->id) }}" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group validated">
                                            <label>@lang('dashboard.region_name')</label> <span class="text-danger"> *</span>
